...
\FigurePlaceholder{fig-ch33-overview.png}{0.90}{合成可能な設計の全体像}{fig:ch33-overview}
...
\FigurePlaceholder{fig-ch33-boundaries.png}{0.90}{入出力型で処理境界をそろえる}{fig:ch33-boundaries}
...
\FigurePlaceholder{fig-ch33-etl-pipeline.png}{0.92}{ETLパイプラインを射の合成として見る}{fig:ch33-etl-pipeline}
