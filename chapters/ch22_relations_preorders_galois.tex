...
\FigurePlaceholder{fig-ch22-equality-vs-order.png}{0.90}{等式で表す意味保存と、順序で表す安全な近似の違い}{fig:ch22-equality-vs-order}
...
\FigurePlaceholder{fig-ch22-preorder-chain.png}{0.88}{ログ詳細度を前順序として見る}{fig:ch22-preorder-chain}
...
\FigurePlaceholder{fig-ch22-abstraction-concretization.png}{0.92}{詳細な世界と抽象的な世界を抽象化・具体化で結ぶ}{fig:ch22-abstraction-concretization}

\section{Galois 接続：抽象化と具体化の対応}

本章では、\(\alpha(a) \leq b \Longleftrightarrow a \leq \gamma(b)\) の向きを採用する。前順序を圏と見たときの随伴との対応は標準的な圏論の定式化に従う~\cite{riehl-category-theory-in-context}。
...
\FigurePlaceholder{fig-ch22-galois-law.png}{0.94}{Galois接続の法則：抽象側の比較と具体側の比較が対応する}{fig:ch22-galois-law}
...
\FigurePlaceholder{fig-ch22-public-log-mask.png}{0.94}{詳細ログから公開ログへ落とすときに証明する性質}{fig:ch22-public-log-mask}
