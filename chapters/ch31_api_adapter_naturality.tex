...
\FigurePlaceholder{fig-ch31-response-shape-change.png}{0.92}{旧APIレスポンスから新APIレスポンスへの包み替え}{fig:ch31-response-shape-change}
...
\FigurePlaceholder{fig-ch31-naturality-square.png}{0.88}{API adapter の自然性の四角形}{fig:ch31-naturality-square}
...
\FigurePlaceholder{fig-ch31-adapter-review-boundary.png}{0.90}{Leanで証明する範囲と実務レビューで確認する範囲}{fig:ch31-adapter-review-boundary}
...
この証明は、adapter が業務ロジックと干渉しないこと、つまり adapter の位置を変えても結果が同じであることを示す。
