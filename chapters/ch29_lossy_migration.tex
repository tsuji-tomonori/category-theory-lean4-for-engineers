...
トークン化済みの \texttt{fullName} は、生の文字列に含まれていた情報の一部が新形式に収まらない状況を表すためのモデルです。
...
\ChapterRef{chap:ch28_user_schema_lossless_migration}では、旧形式と新形式が同じ情報を持つ場合を扱いました。
