...
\FigurePlaceholder{fig-ch29-lossy-overview.png}{0.92}{lossy migration では完全復元ではなく弱めた仕様を証明する}{fig:ch29-lossy-overview}
...
\FigurePlaceholder{fig-ch29-spec-weakening.png}{0.92}{強い仕様を弱めて証明可能な仕様へ落とす流れ}{fig:ch29-spec-weakening}
...
\FigurePlaceholder{fig-ch29-normalization-quotient.png}{0.92}{複数の旧データが同じ新データへ落ちる様子}{fig:ch29-normalization-quotient}
