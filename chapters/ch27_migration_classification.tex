...
\FigurePlaceholder{fig-ch27-migration-taxonomy.png}{0.92}{マイグレーションを、完全同型、片方向互換、情報損失、制約付き同型、仕様弱化へ分類する概念地図}{fig:ch27-migration-taxonomy}
...
\FigurePlaceholder{fig-ch27-roundtrip-laws.png}{0.88}{完全同型では、旧形式から新形式へ移して戻す経路と、新形式から旧形式へ戻して移す経路の両方が恒等変換になる}{fig:ch27-roundtrip-laws}
...
\FigurePlaceholder{fig-ch27-proof-choice.png}{0.90}{マイグレーションで証明すべき性質を選ぶための判断フロー}{fig:ch27-proof-choice}
