...
\FigurePlaceholder{fig-ch20-list-induction.png}{0.90}{空リストと cons ケースから任意長のリストを覆う帰納法}{fig:ch20-list-induction}
...
\FigurePlaceholder{fig-ch20-tree-induction.png}{0.90}{左右の部分木の仮定から木全体の性質を示す構造帰納法}{fig:ch20-tree-induction}
...
\path{tree_map_preserves_size} は任意の型と任意の変換関数について成り立つ。
\path{migrateUserTree_preserves_size} は、それをユーザー移行へ特殊化した定理である。
