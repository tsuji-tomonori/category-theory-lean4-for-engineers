...
\BookIndex{まいぐれーしょんちぇっくりすと}{マイグレーションチェックリスト}
...
本付録は、実装前の設計レビュー、移行 PR のレビュー、CI に入れる Lean 定理の選定、移行後の監査資料に使えます。
...
図\ref{fig:appD-migration-proof-flow}は、本付録の読み方を表しています。
