...
\FigurePlaceholder{fig-ch13-product-coproduct-overview.png}{0.90}{積は「両方」、余積は「どちらか一方」を表す}{fig:ch13-product-coproduct-overview}
...
\FigurePlaceholder{fig-ch13-product-universal.png}{0.90}{積の普遍性：同じ入力から二つの値を作れるなら、ペアを作る関数が一意に決まる}{fig:ch13-product-universal}
...
\FigurePlaceholder{fig-ch13-coproduct-universal.png}{0.90}{余積の普遍性：左右それぞれの処理を与えると、分岐全体の処理が一意に決まる}{fig:ch13-coproduct-universal}
...
\FigurePlaceholder{fig-ch13-api-response-design.png}{0.90}{レスポンス設計：成功値とエラーを同時に持つのか、どちらか一方として持つのかを区別する}{fig:ch13-api-response-design}
