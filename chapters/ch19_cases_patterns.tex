...
\FigurePlaceholder{fig-ch19-cases-overview.png}{0.90}{\texttt{cases} によって値の全パターンを証明ゴールへ分解する流れ}{fig:ch19-cases-overview}
...
\FigurePlaceholder{fig-ch19-validation-postcondition.png}{0.90}{バリデーション結果ごとに異なる事後条件を確認する構造}{fig:ch19-validation-postcondition}
