...
\FigurePlaceholder{fig-ch23-pullback-join.png}{0.90}{プロフィールと注文が共通のユーザーIDで整合する合流点}{fig:ch23-pullback-join}
...
\FigurePlaceholder{fig-ch23-universal-property.png}{0.90}{二つの射影を保つ媒介写像が存在し、その条件を満たす写像は一意である}{fig:ch23-universal-property}
...
theorem toProfileOrder_unique {X : Type}
  ...
  | mk p o consistent =>
      ...
      rfl
\end{minted}
\caption{任意の整合データからの媒介写像と、その一意性}
...
\FigurePlaceholder{fig-ch23-api-db-consistency.png}{0.92}{DB、API、配送情報を共通キーで整合させる}{fig:ch23-api-db-consistency}
