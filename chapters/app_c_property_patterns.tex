...
\path{migrateItems_preserves_length}は、要素を変換してもリストの件数は変わらないことを帰納法で示している。
...
\path{withdrawChecked_success_post}は、\texttt{some newBalance}が返った場合、その値が期待する条件を満たすことを示す例である。
