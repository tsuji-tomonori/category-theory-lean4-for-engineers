...
\texttt{some \{ a with balance := a.balance - amount \}} の \texttt{with} も、コード\ref{lst:ch10_invariant_predicate}と同じ構造体更新記法です。
元の \texttt{ownerId} を引き継ぎ、残高だけを減らした新しい口座を \texttt{some} に包んで返します。
