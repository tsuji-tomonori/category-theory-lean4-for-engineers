...
\FigurePlaceholder{fig-ch10-invariant-flow.png}{0.90}{データ構造・不変条件・操作・証明の関係}{fig:ch10-invariant-flow}
...
\FigurePlaceholder{fig-ch10-pre-post-invariant.png}{0.92}{事前条件・操作・事後条件・不変条件の時間的な関係}{fig:ch10-pre-post-invariant}
...
\FigurePlaceholder{fig-ch10-subtype-gate.png}{0.88}{Subtypeを条件付きデータの入口として読む}{fig:ch10-subtype-gate}
