...
\FigurePlaceholder{fig-ch14-overview.png}{0.92}{関手は中身の変換を構造全体へ持ち上げる}{fig:ch14-overview}
...
\FigurePlaceholder{fig-ch14-object-arrow-mapping.png}{0.92}{型の対応と関数の対応を同時に持つものとしての関手}{fig:ch14-object-arrow-mapping}
...
\FigurePlaceholder{fig-ch14-functor-laws.png}{0.90}{関手則：恒等関数の保存と合成の保存}{fig:ch14-functor-laws}
...
\FigurePlaceholder{fig-ch14-migration-lift.png}{0.92}{一件の移行を List.map でバッチ移行へ持ち上げる}{fig:ch14-migration-lift}
