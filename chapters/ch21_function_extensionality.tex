...
\FigurePlaceholder{fig-ch21-overview.png}{0.90}{関数外延性の概念地図：実装の違いではなく全入力での振る舞い一致を見る}{fig:ch21-overview}
...
\FigurePlaceholder{fig-ch21-funext-proof.png}{0.88}{\texttt{funext} による証明の形：関数等式を任意入力での等式へ分解する}{fig:ch21-funext-proof}
...
\FigurePlaceholder{fig-ch21-api-wrapper.png}{0.92}{新旧 API client wrapper の同値性：任意のリクエストでレスポンスが一致する}{fig:ch21-api-wrapper}
