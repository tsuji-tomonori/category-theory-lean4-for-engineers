...
ユーザー情報と注文情報の分割は、正規化としては自然な変更です。
...
移行後の新クエリと移行前の旧クエリの結果が一致するとき、そのクエリに関して移行が意味を保存しているといいます。
...
本章の考え方を実務へ持ち込むなら、次の順で進めるとよいでしょう。
